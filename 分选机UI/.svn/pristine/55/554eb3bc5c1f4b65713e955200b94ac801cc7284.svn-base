          ...
          <div class="column1">
            <div class="column1-1">
              ...
              <a-form
                ...
                :wrapper-col="{ span: 16 }"
                :colon="false">
                <a-form-item label="合格是的" name="合格等级1">
                  <a-select
                    ...
                    :defaultOpen="true">
                    <a-select-option value="jack">的萨达</a-select-option>
            ...
            <div class="column1-2">
              ...
              <a-form
                ...
                <a-form-item label="传感器型号" name="合格等级1">
                  <a-select placeholder="测试" :defaultOpen="true">
                    <a-select-option value="jack">Jackggg</a-select-option>
                    <a-select-option value="lucy">Lucy</a-select-option>
                  </a-select>
                </a-form-item>
...
.adaptive-select .ant-select-dropdown {
